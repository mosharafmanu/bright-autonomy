...
<section class="blog-hero layout-padding">
	...
	<?php if ( 'video' === $media_type && $video && function_exists( 'bright_autonomy_render_video' ) ) : ?>
		<div class="blog-hero-media">
			<?php bright_autonomy_render_video( $video, [ 'behavior' => 'autoplay', 'lazy' => false ] ); ?>
		</div>
	<?php elseif ( 'image' === $media_type && $image && function_exists( 'bright_autonomy_render_responsive_picture' ) ) : ?>
		<div class="blog-hero-media">
			<?php
