...
if ( ! function_exists( 'bright_autonomy_get_header_button' ) ) {
	function bright_autonomy_get_header_button() {
...
if ( ! function_exists( 'bright_autonomy_get_site_logo' ) ) {
	function bright_autonomy_get_site_logo() {
		if ( ! function_exists( 'get_field' ) ) {
			return false;
		}
...
if ( ! function_exists( 'bright_autonomy_render_site_logo' ) ) {
	function bright_autonomy_render_site_logo( $args = [] ) {
		$logo = bright_autonomy_get_site_logo();
...
if ( ! function_exists( 'bright_autonomy_get_footer_tagline' ) ) {
	function bright_autonomy_get_footer_tagline() {
		if ( ! function_exists( 'get_field' ) ) {
			return false;
		}
...
if ( ! function_exists( 'bright_autonomy_render_footer_tagline' ) ) {
	function bright_autonomy_render_footer_tagline( $args = [] ) {
		$tagline = bright_autonomy_get_footer_tagline();
		if ( ! $tagline ) {
			return;
		}
...
if ( ! function_exists( 'bright_autonomy_get_footer_logo' ) ) {
	function bright_autonomy_get_footer_logo() {
		if ( ! function_exists( 'get_field' ) ) {
			return false;
		}
...
if ( ! function_exists( 'bright_autonomy_render_footer_logo' ) ) {
	function bright_autonomy_render_footer_logo( $args = [] ) {
		if ( ! function_exists( 'bright_autonomy_render_responsive_picture' ) ) {
			return;
		}

		$logo = bright_autonomy_get_footer_logo();
...
if ( ! function_exists( 'bright_autonomy_get_social_medias' ) ) {
	function bright_autonomy_get_social_medias() {
		if ( ! function_exists( 'get_field' ) ) {
			return false;
		}
...
if ( ! function_exists( 'bright_autonomy_get_footer_copyright' ) ) {
	function bright_autonomy_get_footer_copyright() {
		if ( ! function_exists( 'get_field' ) ) {
			return false;
		}
...
if ( ! function_exists( 'bright_autonomy_render_footer_menu' ) ) {
	function bright_autonomy_render_footer_menu( $args = [] ) {
		$defaults = [
			'location'        => '',
...
if ( ! function_exists( 'bright_autonomy_render_social_medias' ) ) {
	function bright_autonomy_render_social_medias( $args = [] ) {
		$defaults = [
		...
		$social_medias = bright_autonomy_get_social_medias();
...
if ( ! function_exists( 'bright_autonomy_render_footer_copyright' ) ) {
	function bright_autonomy_render_footer_copyright( $args = [] ) {
		$defaults = [
		...
		$copyright = bright_autonomy_get_footer_copyright();
