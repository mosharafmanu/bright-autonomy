...
- Removed old Media Library attachment posts/meta after confirming page SEO rows should be preserved.
...
- Upload files and old Media Library attachment rows were removed from the old WordPress install.
