...
if ( ! function_exists( 'bright_autonomy_render_video_autoplay_controls' ) ) {
	 ...
	 */
	function bright_autonomy_render_video_autoplay_controls( $args = [] ) {
		$defaults = [
			'class' => '',
			'echo'  => true,
		];
		...
		$html .= '<button class="video-control-btn video-play-pause-btn" aria-label="' . esc_attr__( 'Play/Pause', 'bright-autonomy' ) . '">';
		$html .= bright_autonomy_render_video_control_icon( 'play' );
		$html .= bright_autonomy_render_video_control_icon( 'pause' );
		$html .= '</button>';

		// Mute/Unmute Button - Both icons inside
		$html .= '<button class="video-control-btn video-mute-btn" aria-label="' . esc_attr__( 'Mute/Unmute', 'bright-autonomy' ) . '">';
		$html .= bright_autonomy_render_video_control_icon( 'unmute' );
		$html .= bright_autonomy_render_video_control_icon( 'mute' );
		$html .= '</button>';
...
if ( ! function_exists( 'bright_autonomy_render_video_control_icon' ) ) {
	/**
	 ...
	 */
	function bright_autonomy_render_video_control_icon( $icon ) {
		$icons = [
