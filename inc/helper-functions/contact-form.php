 ...
 * @return string
 */
if ( ! function_exists( 'bright_autonomy_get_submit_icon_svg' ) ) {
	function bright_autonomy_get_submit_icon_svg() {
 ...
 * @return string
 */
if ( ! function_exists( 'bright_autonomy_cf7_submit_button_icon' ) ) {
	function bright_autonomy_cf7_submit_button_icon( $html ) {
		...
		return preg_replace_callback(
			...
			function ( $matches ) {
				...
				$icon = bright_autonomy_get_submit_icon_svg();
...
add_filter( 'wpcf7_form_elements', 'bright_autonomy_cf7_submit_button_icon' );
