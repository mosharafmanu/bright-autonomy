	...
	<main id="primary" class="site-main">
		...
		<section class="error-404 not-found layout-padding pt-50 pt-md-70 pt-lg-100 pb-50 pb-md-70 pb-lg-100">
			<div class="error-404-wrapper">
				...
				<h1 class="error-404-title"><?php esc_html_e( 'Page Not Found', 'bright-autonomy' ); ?></h1>

				<p class="error-404-text"><?php esc_html_e( "The page you're looking for doesn't exist or has been moved.", 'bright-autonomy' ); ?></p>

				<div class="error-404-actions btns">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="site-btn btn-primary">
						<?php esc_html_e( 'Back to Home', 'bright-autonomy' ); ?>
					</a>
				</div>
