...
?>
	...
	<main id="primary" class="site-main search-results-page">
		...
		<?php if ( function_exists( 'bright_autonomy_breadcrumb' ) ) : ?>
			<?php bright_autonomy_breadcrumb( true ); ?>
		<?php endif; ?>
		...
		<header class="search-results-header mc-container layout-padding pt-50 pt-md-70 pt-lg-100">
			<span class="archive-label"><?php esc_html_e( 'Search', 'bright-autonomy' ); ?></span>
			<h1 class="archive-title">
				<?php printf(
					/* translators: %s: search query */
					esc_html__( 'Results for "%s"', 'bright-autonomy' ),
					esc_html( get_search_query() )
				); ?>
			</h1>
			<?php if ( $result_count > 0 ) : ?>
				<p class="search-result-count"><?php printf(
					esc_html( _n( '%s result found', '%s results found', $result_count, 'bright-autonomy' ) ),
		...
		<?php if ( have_posts() ) :
			...
			<?php if ( $products_html ) : ?>
				<section class="search-results-group search-results-group--products mc-container layout-padding pt-40 pt-md-50">
					<h2 class="search-results-group__title">
						<?php esc_html_e( 'Products', 'bright-autonomy' ); ?>
			...
			<?php if ( $articles_html ) : ?>
				<section class="search-results-group search-results-group--articles mc-container layout-padding pt-40 pt-md-50 pb-50 pb-md-70 pb-lg-100">
					<h2 class="search-results-group__title">
						<?php esc_html_e( 'Articles', 'bright-autonomy' ); ?>
			...
			<?php
			if ( function_exists( 'bright_autonomy_render_pagination' ) ) {
				bright_autonomy_render_pagination();
			}
			?>
		...
		<?php else : ?>
			...
			<div class="search-no-results mc-container layout-padding pt-50 pb-50 pb-md-70 pb-lg-100">
				<p class="search-no-results__text"><?php printf(
					/* translators: %s: search query */
					esc_html__( 'Sorry, nothing matched "%s". Try a different search term.', 'bright-autonomy' ),
					esc_html( get_search_query() )
				); ?></p>
				<?php get_search_form(); ?>
			</div>
