	...
	<header class="single-post__hero <?php echo esc_attr( $mc_hero_class ); ?>">
		<?php if ( $mc_has_image ) :
			...
			<div class="single-post__hero-media" aria-hidden="true">
				<?php if ( function_exists( 'bright_autonomy_render_responsive_picture' ) ) :
					...
					the_post_thumbnail( 'bright-1200', [ 'class' => 'single-post__hero-image' ] );
				endif; ?>
			</div>
		...
		<div class="single-post__hero-inner mc-container layout-padding">
			<?php if ( function_exists( 'bright_autonomy_breadcrumb' ) ) { bright_autonomy_breadcrumb( false, '', '' ); } ?>
			...
			<div class="entry-meta">
				<span class="entry-author">
					...
					<span class="entry-author__name">
						...
						printf(
							...
							esc_html__( 'By %s', 'bright-autonomy' ),
				...
				<span class="entry-read-time">
					...
					printf(
						...
						esc_html( _n( '%s min read', '%s min read', $mc_read_time, 'bright-autonomy' ) ),
		...
		<div class="entry-content mt-40 mt-md-50">
			...
			the_content( sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'bright-autonomy' ),
					[ 'span' => [ 'class' => [] ] ]
				),
			...
			wp_link_pages( [
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'bright-autonomy' ),
				'after'  => '</div>',
			] );
			?>
		</div>
