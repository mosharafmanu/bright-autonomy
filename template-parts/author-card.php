...
<aside class="author-card">
	...
	<div class="author-card__body">
		<span class="author-card__eyebrow"><?php esc_html_e( 'Written by', 'bright-autonomy' ); ?></span>
		...
		<a class="author-card__link" href="<?php echo esc_url( $mc_author_url ); ?>">
			<span><?php printf( esc_html__( 'More from %s', 'bright-autonomy' ), esc_html( $mc_author_name ) ); ?></span>
